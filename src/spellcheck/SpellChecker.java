...
public class SpellChecker{
    ...
    final static String Path = "C:\\Users\\Lenovo\\Desktop\\words.txt";
    final static char[] alphas = "abcdefghijklmnopqrstuvwxyz".toCharArray();
    ...
    void run() {
        ...
        while (true) {
            System.out.print("\nEnter a word to test Suraj's spellcheck: ");
            input = scan.nextLine();
            if (input.equals("")) {
                break;
            }
            if (dict.contains(input)) {
                System.out.println("\n" + input + " Woohh!! you spelled it correctly.");
            } else {
                System.out.print("This is incorrectly spelled...");
